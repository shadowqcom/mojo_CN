...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      // 当用户位于 `手册` 目录时，会显示此侧边栏
      '/mojo/manual/': [
        {
          text: ' Mojo手册',
          items: [
            {text: '介绍', link: '/mojo/manual/'},
            {text: '开始使用',
            collapsed: false,
            items: [
      ...
      '/mojo/reference/': [
        {
          ...
          items: [
            ...
            { text: '装饰器',
                collapsed: false,
                items: [
                { text: '@always_inline', link: 'mojo/reference/decorators/@always_inline' },
                { text: '@nonmaterializable', link: 'mojo/reference/decorators/@nonmaterializable' },
                { text: '@parameter', link: 'mojo/reference/decorators/@parameter' },
                { text: '@register_passable', link: 'mojo/reference/decorators/@register_passable' },
                { text: '@staticmethod', link: 'mojo/reference/decorators/@staticmethod' },
                { text: '@unroll', link: 'mojo/reference/decorators/@unroll' },
                { text: '@value', link: 'mojo/reference/decorators/@value' },
                ],
            },
            { text: '命令行',
            collapsed: false,
            items: [
              { text: 'mojo', link: 'mojo/reference/mojocli/mojo' },
              { text: 'mojo build', link: 'mojo/reference/mojocli/mojo build' },
              { text: 'mojo debug', link: 'mojo/reference/mojocli/mojo debug' },
              { text: 'mojo demangle', link: 'mojo/reference/mojocli/mojo demangle' },
              { text: 'mojo doc', link: 'mojo/reference/mojocli/mojo doc' },
              { text: 'mojo format', link: 'mojo/reference/mojocli/mojo format' },
              { text: 'mojo package', link: 'mojo/reference/mojocli/mojo package' },
              { text: 'mojo repl', link: 'mojo/reference/mojocli/mojo repl' },
              { text: 'mojo run', link: 'mojo/reference/mojocli/mojo run' },
              ],
            },
          ],
        },
      ...
      // 当用户位于 `engine` 目录时，会显示此侧边栏
      '/engine/': [

      ],

      // 当用户位于 `max` 目录时，会显示此侧边栏
      '/max/': [
