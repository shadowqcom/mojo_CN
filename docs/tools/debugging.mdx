...
the MAX framework, [install the `modular` package](/max/packages), which
...
[GPU debugging](/docs/tools/gpu-debugging/).
...
repo](https://github.com/modular/modular/tree/main/mojo/examples).
...
<kbd>Control+Shift+D</kbd> (<kbd>Command+Shift+D</kbd> on macOS).
