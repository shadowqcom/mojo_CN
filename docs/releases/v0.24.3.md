...
- `AnyPointer` was renamed to
  [`UnsafePointer`](/docs/std/memory/unsafe_pointer/UnsafePointer/) and is now
  ...
  - Because of this, the `take_value()`, `emplace_value()`, and `move_into()`
    ...
    - [`initialize_pointee_copy`](/docs/std/memory/unsafe_pointer/UnsafePointer/#init_pointee_copy)
    - [`initialize_pointee_move`](/docs/std/memory/unsafe_pointer/UnsafePointer/#init_pointee_move)
    - [`move_from_pointee()`](/docs/std/memory/unsafe_pointer/UnsafePointer/#take_pointee)
    - [`move_pointee`](/docs/std/memory/unsafe_pointer/UnsafePointer/#move_pointee_into)
...
- All of the pointer types received some cleanup to make them more consistent,
  ...
  [`bitcast()`](/docs/std/memory/unsafe_pointer/UnsafePointer/#bitcast) method
...
- The `Reference` type has several
  ...
  - `Reference` now has an
    [`unsafe_bitcast()`](/docs/std/memory/unsafe_pointer/UnsafePointer/#bitcast)
...
- [`FileHandle.read()`](/docs/std/io/file/FileHandle/#read) can now
  ...
  [`DTypePointer`](/docs/std/memory/unsafe_pointer/UnsafePointer/):
...
- [`bool(None)`](/docs/std/builtin/bool/bool-function/) is now implemented.
  (@zhoujingya)

- The [`DTypePointer`](/docs/std/memory/unsafe_pointer/UnsafePointer/) type
...
- The [`parallel_memcpy()`](/docs/std/algorithm/memory/parallel_memcpy/)
