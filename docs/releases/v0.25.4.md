...
- The entire MAX Kernel library is now fully open sourced! For more information,
  see the [MAX AI kernels library reference](/docs/lib/#max-ai-kernels-library)
  and the
...
- The Mojo compiler will now synthesize `__moveinit__()`, `__copyinit__()`, and
  ...
  [`Copyable`](/docs/std/builtin/value/Copyable/), and `ExplicitlyCopyable`
...
- GPU programming enhancements and changes:
  ...
  - Primitives for working with NVIDIA Blackwell GPUs have been added, providing
    ...
    [`gpu.tcgen05`](/docs/std/gpu/compute/arch/tcgen05/) module API reference
  ...
  - Fixed the `sum()` and `prefix_sum()` implementations in the
    [`gpu.block`](/docs/std/gpu/primitives/block/) and
...
- Collection type enhancements and changes:
  ...
  - The `CollectionElement` trait has been removed. You can replace any use of
    it with the [`Copyable`](/docs/std/builtin/value/Copyable/) and
    [`Movable`](/docs/std/builtin/value/Movable/) traits, or the
    `Copyable & Movable`
    [trait composition](/docs/manual/traits/#trait-compositions).
...
- [`PythonObject`](/docs/std/python/python_object/PythonObject/) has new
  ...
  - [`PythonObject.unchecked_downcast_value_ptr[T]()`](/docs/std/python/python_object/PythonObject/#unchecked_downcast_value_ptr)
    ...
    [`UnsafePointer`](/docs/std/memory/unsafe_pointer/UnsafePointer/#__init__)
...
- The [`compile`](/docs/std/compile/) module now provides the
  [`get_type_name()`](/docs/std/reflection/type_info/get_type_name/) function
