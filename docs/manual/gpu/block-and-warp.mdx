...
github_url: https://github.com/modular/modular/tree/main/mojo/examples/gpu-block-and-warp
---
...
- [`prefix_sum[exclusive=False](val)`](/docs/std/gpu/primitives/block/prefix_sum/):
...
- [`prefix_sum[exclusive=False](value)`](/docs/std/gpu/primitives/warp/prefix_sum/):
  Computes an inclusive (default) or exclusive prefix sum (scan) across threads
