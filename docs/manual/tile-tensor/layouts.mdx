...
- The [`tile_layout.Layout`](/docs/layout/tile_layout/Layout/) struct
  ...
  linear index value. Layouts can also describe more complex organizations, like
  a matrix subdivided into tiles.
- [`Coord`](/docs/layout/coord/Coord/) is a tuple-like container for
...
[public GitHub repo](https://github.com/modular/modular/tree/main/mojo/docs/code/manual/tile-tensor/layouts/).
...
The [`print_layout()`](/docs/layout/layout/print_layout/) function
...
also provides an [`idx2crd()`](/docs/layout/tile_layout/Layout/#idx2crd)
...
[`Coord`](/docs/layout/coord/Coord/) type, a tuple-like structure that
...
values using the [`coord()`](/docs/layout/coord/coord-function/) function:
...
The [`coord`](/docs/layout/coord/) package provides a number of
...
[`row_major()`](/docs/layout/tile_layout/row_major/) and
[`col_major()`](/docs/layout/tile_layout/col_major/) functions are
...
The [`zipped_divide()`](/docs/layout/tile_layout/zipped_divide/)
